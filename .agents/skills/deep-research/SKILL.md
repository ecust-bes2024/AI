...
Codex default limit: 32,000 output tokens (≈24,000 words total per skill execution)
...
Create file: `~/.Codex/research_output/continuation_state_[report_id].json`
